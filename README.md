...
A Kodi video plugin for browsing and streaming movies and TV shows.
...
1. Install the addon
2. Open **Settings → TorBox** and enter your API key, or **Settings → Real Debrid** and authenticate
3. Optionally connect **Trakt** in **Settings → Trakt** for watchlist and scrobbling
4. Browse and enjoy
